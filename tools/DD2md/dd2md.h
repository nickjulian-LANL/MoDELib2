...
class AtomDisplacementGenerator
{
   private:
      ...
      std::vector<VectorDim> lammpsBoxVertices;
      std::vector<VectorDim> lammpsBoxPBCVectors;
      ...
      std::unique_ptr<DDconfigIO<3>> configIO;
   ...
   public:
      ...
      AtomDisplacementGenerator(
         ...
         , configIO( std::make_unique<DDconfigIO<3> >( modelibFolderPath + "/evl"))
      ...
      py::array_t<double, py::array::c_style>
         getLammpsBoxVertices();
      py::array_t<double, py::array::c_style>
         getLammpsBoxPBCVectors();
